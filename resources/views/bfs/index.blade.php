...
@section('content')
    ...
    <form action="{{route('bfs.post')}}"  class="w-25" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="B3" class="form-control" id="B3">
        </div>
        ...
        <div class="mb-3">
            <label for="E2" class="form-label">2</label>
            <input type="text" name="E2" class="form-control" id="E2">
        </div>
        ...
        <div class="mb-3">
            <label for="F2" class="form-label">2</label>
            <input type="text" name="F2" class="form-control" id="F2">
        </div>
